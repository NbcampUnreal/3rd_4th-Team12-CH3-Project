...
void USTGameOverWidget::SetResultInfo(int32 Score, int32 KillCount, int32 DamageDealt, int32 DamageTaken, const FText& ReasonText)
{
	if (Txt_Score)
	...
	if (Txt_GameOverReason)
		Txt_GameOverReason->SetText(ReasonText);
}
